...
$.host = ($.isNode() ? process.env["tonghuaios_host"] : $.getdata('tonghuaios_host')) || 'tonghuaios.com';
//------------------------------------------
async function main() {
    ...
    async Login(token) {
        try {
            const opts = {
                ...
                dataType: "form",
                resultType: "all",
                body: `user_login=${this.phone}&password=${this.password}&rememberme=1&redirect=https%3A%2F%2Ftonghuaios.com%2F&action=userlogin_form&token=${token}`
