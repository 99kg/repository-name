...
* @ScriptURL         https://raw.githubusercontent.com/99kg/repository-name/master/QuantumultX/Cuttlefish/Script/mmjz.js
* ==/UserScript==

【QuantumultX】 :
*************************
[rewrite_local]
https://meow-api.sxyj.net/api/Member/SignNew url script-request-header https://raw.githubusercontent.com/99kg/repository-name/master/QuantumultX/Cuttlefish/Script/mmjz.js
[task_local]
15 7,15 * * * https://raw.githubusercontent.com/99kg/repository-name/master/QuantumultX/Cuttlefish/Script/mmjz.js, tag=喵喵记账, img-url=https://github.com/ddgksf2013/Icon/raw/master/mmjz.png
*************************
【Loon】 :
*************************
[Script]
http-request https://meow-api.sxyj.net/api/Member/SignNew tag=喵喵记账Cookie, script-path=https://raw.githubusercontent.com/99kg/repository-name/master/QuantumultX/Cuttlefish/Script/mmjz.js
cron "15 7,15 * * *" script-path=https://raw.githubusercontent.com/99kg/repository-name/master/QuantumultX/Cuttlefish/Script/mmjz.js,tag=喵喵记账
*************************
【Surge】 :
*************************
[Script]
喵喵记账 = type=cron,cronexp="15 7,15 * * *",wake-system=1,timeout=120,script-path=https://raw.githubusercontent.com/99kg/repository-name/master/QuantumultX/Cuttlefish/Script/mmjz.js
喵喵记账Cookie = type=http-request,pattern=https://meow-api.sxyj.net/api/Member/SignNew,script-path=https://raw.githubusercontent.com/99kg/repository-name/master/QuantumultX/Cuttlefish/Script/mmjz.js
*************************
【小火箭】 :
*************************
[Script]
喵喵记账 = type=cron,script-path=https://raw.githubusercontent.com/99kg/repository-name/master/QuantumultX/Cuttlefish/Script/mmjz.js, cronexpr="15 7,15 * * *", timeout=500, enable=true
喵喵记账Cookie = type=http-request,pattern=https://meow-api.sxyj.net/api/Member/SignNew,script-path=https://raw.githubusercontent.com/99kg/repository-name/master/QuantumultX/Cuttlefish/Script/mmjz.js
*************************
